...
int main( int argc , char *argv[] )
{
    ...
    printf("\tAmal-to-KDC   pipe: read=%d  write=%d\n", KDC_to_Amal[ READ_END ]   , KDC_to_Amal[ WRITE_END ]   ) ;
    printf("\tKDC-to-Amal   pipe: read=%d  write=%d\n", Amal_to_KDC[ READ_END ]   , Amal_to_KDC[ WRITE_END ]   ) ;
    printf("\tAmal-to-Basim pipe: read=%d  write=%d\n", Amal_to_Basim[ READ_END ] , Amal_to_Basim[ WRITE_END ] ) ;
    printf("\tBasim-to_Amal pipe: read=%d  write=%d\n", Basim_to_Amal[ READ_END ] , Basim_to_Amal[ WRITE_END ] ) ;
